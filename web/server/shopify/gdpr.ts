...
const GDPRWebhookHandlers: WebhookHandlersParam = {
    ...
    CUSTOMERS_DATA_REQUEST: {
        ...
        callback: async (topic: any, shop: any, body: string, webhookId: any) => {
            ...
            console.log('topic CUSTOMERS_DATA_REQUEST==>', topic)
            console.log('shop CUSTOMERS_DATA_REQUEST==>', shop)
            console.log('payload CUSTOMERS_DATA_REQUEST==>', payload)
            console.log('webhookId CUSTOMERS_DATA_REQUEST==>', webhookId)
